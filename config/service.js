...
var DemoBot = angular.module('DemoBot');
DemoBot.service('Util', function($filter) {
...
DemoBot.service('BSServiceUtil', function(notify, ExportService, BSService, Cache) {
...
DemoBot.service('EmailService', function(notify, BSService) {
...
DemoBot.service('CommentService', function(notify, BSService) {
...
DemoBot.factory('ExportService', function($resource) {
...
DemoBot.factory('BSService', function($resource) {
...
DemoBot.service('AlertService', function(SweetAlert,notify) {
...
DemoBot.service('AppService', function(notify, BSServiceUtil, AlertService, Cache) {
...
DemoBot.service('Cache', function() {
    var map;
